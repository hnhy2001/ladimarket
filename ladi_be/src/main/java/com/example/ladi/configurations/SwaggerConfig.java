...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).select()
                .apis(RequestHandlerSelectors.basePackage("com.example.ladi"))
    ...
    private ApiInfo apiEndPointsInfo() {
        return new ApiInfoBuilder().title("Flive Streaming API")
                .description("Flive Streaming API Mockup 2022-May" +
