...
import { ThemSuaXoaCostMarketingComponent } from 'app/shared/popup/them-sua-xoa-cost-mkt/them-sua-xoa-cost-mkt.component';
...
@Component({
    selector: 'cost-cmp',
    templateUrl: './cost-mkt.component.html'
})

export class CostMarketingComponent implements OnInit, AfterViewInit {
    ...
    public updateData() {
        ...
        const modalRef = this.modalService.open(ThemSuaXoaCostMarketingComponent, { size: 'l' });
